...
/// Final Color:
                ...
                float node_600 = 3.0;
                float node_7604 = pow((_Cloud_var.r*node_600),node_600);
                ...
                fixed4 finalRGBA = fixed4(finalColor,lerp(node_5755,lerp(_Opacity,lerp(_Opacity,node_5755,node_7604),_Up_mask_var.r),_Upper_mask_var.r));
...
/// Final Color:
                ...
                float4 _Up_mask_var = tex2D(_Up_mask,TRANSFORM_TEX(i.uv0, _Up_mask));
                float4 _Upper_mask_var = tex2D(_Upper_mask,TRANSFORM_TEX(i.uv0, _Upper_mask));
                fixed4 finalRGBA = fixed4(finalColor * lerp(node_5755,lerp(_Opacity,lerp(_Opacity,node_5755,node_7604),_Up_mask_var.r),_Upper_mask_var.r),0);
                UNITY_APPLY_FOG(i.fogCoord, finalRGBA);
                return finalRGBA;
            }
            ENDCG
