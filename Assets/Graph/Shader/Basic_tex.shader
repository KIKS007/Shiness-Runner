...
////// Emissive:
                ...
                float3 node_5714 = (_Color.rgb*_Diffuse_var.rgb);
                ...
                float3 finalColor = emissive + (((node_5714*lerp((node_9574_if_leA*node_5914)+(node_9574_if_leB*1.0),node_5914,node_9574_if_leA*node_9574_if_leB))+((_Use_light*(step(0.3,pow(max(0,dot(lightDirection,viewReflectDirection)),exp2((_Gloss_var.rgb*10.0+1.0))))*_Light_intensity))*_Spec_var.rgb))*_LightColor0.rgb);
...
////// Lighting:
                ...
                float4 _Gloss_var = tex2D(_Gloss,TRANSFORM_TEX(i.uv0, _Gloss));
                float4 _Spec_var = tex2D(_Spec,TRANSFORM_TEX(i.uv0, _Spec));
                float3 finalColor = (((node_5714*lerp((node_9574_if_leA*node_5914)+(node_9574_if_leB*1.0),node_5914,node_9574_if_leA*node_9574_if_leB))+((_Use_light*(step(0.3,pow(max(0,dot(lightDirection,viewReflectDirection)),exp2((_Gloss_var.rgb*10.0+1.0))))*_Light_intensity))*_Spec_var.rgb))*_LightColor0.rgb);
